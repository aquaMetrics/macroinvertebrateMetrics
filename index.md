...
![](https://github.com/aquaMetrics/macroinvertebrateMetrics/blob/master/man/figures/macro_logo.png?raw=true)
...
execute the same code except that
[`calc_awic()`](https://aquametrics.github.io/macroinvertebrateMetrics/reference/calc_awic.md)
uses
[`calc_metric()`](https://aquametrics.github.io/macroinvertebrateMetrics/reference/calc_metric.md)
...
1.  The `data` input is passed to a
    [`calc_metric()`](https://aquametrics.github.io/macroinvertebrateMetrics/reference/calc_metric.md)
    function.
...
3.  The `data` (now with the metric values attached) is then passed to
    ...
    [`calc_metric()`](https://aquametrics.github.io/macroinvertebrateMetrics/reference/calc_metric.md)
    function calculates only the requested metrics in-turn and then
    binds and returns the outputs in a final output dataframe.
