...
test_that("test directly against old aquaMetric function", {
  ...
  standardTaxa <- standardTaxa[, c("LOCATION_CODE",
                                   "Season",
                                   "Year",
                                   "MAITLAND_CODE",
                                   "TAXON",
                                   "RESULT")]
  names(standardTaxa) <- c("Site",
                           "Season",
                           "Year",
                           "Maitland Code",
                           "Maitland Name",
  ...
  test <- aquaMetrics::StandardiseRawTaxa(family.df = standardTaxa,
  ...
  checkResults <- inner_join(checkResults,
             ...
             by = c("SAMPLE_ID" = "SAMPLE_ID")) %>% unique()
